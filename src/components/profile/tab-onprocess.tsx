const TabOnProcess = ({ data }) => {
    return (
        <>
            <div className="flex flex-col gap-5 rounded-[15px] md:grid md:grid-cols-2 xl:grid-cols-4 xl:px-18 xl:py-5">
                {data.map((item, index) => (
                    <div
